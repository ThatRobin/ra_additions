...
public class FallMechanic extends Mechanic {
    ...
    public FallMechanic(MechanicType<?> mechanicType, ClaimedLand claimedLand, float damage_multipler, ActionFactory<Entity>.Instance entity_action, ActionFactory<Triple<World, BlockPos, Direction>>.Instance block_action, ConditionFactory<CachedBlockPosition>.Instance block_condition) {
