...
public class UseMechanic extends Mechanic {
    ...
    public UseMechanic(MechanicType<?> mechanicType, ClaimedLand claimedLand, ActionFactory<Entity>.Instance entity_action, ActionFactory<Triple<World, BlockPos, Direction>>.Instance block_action, ConditionFactory<CachedBlockPosition>.Instance block_condition) {
