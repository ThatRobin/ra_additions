...
public class BossBarHudRenderOverlay {
    ...
    public BossBarHudRenderOverlay(boolean shouldRender, int barIndex, int priority, Identifier spriteLocation, ConditionFactory<LivingEntity>.Instance condition, boolean inverted) {
