...
public class DDTickMechanic extends Mechanic {
    ...
    public DDTickMechanic(MechanicType<?> mechanicType, ClaimedLand land, int interval, ActionFactory<Triple<World, BlockPos, Direction>>.Instance action, ConditionFactory<CachedBlockPosition>.Instance block_condition) {
