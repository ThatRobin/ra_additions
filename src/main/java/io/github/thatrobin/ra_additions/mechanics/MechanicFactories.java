...
import io.github.thatrobin.ra_additions.registry.RAA_Registries;
...
public class MechanicFactories {
    ...
    public static void register() {
        register(new MechanicFactory<>(RA_Additions.identifier("tick"),
                ...
                data ->
                        (identifier, claimedLand) -> new DDTickMechanic(identifier, claimedLand, data.getInt("interval"), data.get("block_action"), data.get("block_condition")))
        );
        ...
        register(new MechanicFactory<>(RA_Additions.identifier("resource"),
                ...
                data ->
                        (identifier, claimedLand) -> new DDResourceMechanic(identifier, claimedLand, data.getInt("start_value"), data.getInt("min"), data.getInt("max")))
        );
        ...
        register(new MechanicFactory<>(RA_Additions.identifier("on_use"),
                new SerializableData()
                        ...
                        .add("block_condition", ApoliDataTypes.BLOCK_CONDITION, null),
                data ->
                        (identifier, claimedLand) -> new DDUseMechanic(identifier, claimedLand, data.get("entity_action"), data.get("block_action"), data.get("block_condition")))
        );
        ...
        register(new MechanicFactory<>(RA_Additions.identifier("on_step"),
                new SerializableData()
                        ...
                        .add("block_condition", ApoliDataTypes.BLOCK_CONDITION, null),
                data ->
                        (identifier, claimedLand) -> new DDStepMechanic(identifier, claimedLand, data.get("entity_action"), data.get("block_action"), data.get("block_condition")))
        );
        ...
        register(new MechanicFactory<>(RA_Additions.identifier("on_neighbour_update"),
                ...
                data ->
                        (identifier, claimedLand) -> new DDNeighourUpdateMechanic(identifier, claimedLand, data.get("self_action"), data.get("neighbour_action"), data.get("self_condition"), data.get("neighbour_condition")))
        );
        ...
        register(new MechanicFactory<>(RA_Additions.identifier("on_land"),
                new SerializableData()
                        ...
                        .add("entity_action", ApoliDataTypes.ENTITY_ACTION, null),
                data ->
                        (identifier, claimedLand) -> new DDFallMechanic(identifier, claimedLand, data.getFloat("damage_multiplier"), data.get("entity_action"), data.get("block_action"), data.get("block_condition")))
        );
        ...
        register(new MechanicFactory<>(RA_Additions.identifier("triggerable"),
                new SerializableData()
                        ...
                        .add("neighbour_condition", ApoliDataTypes.BLOCK_CONDITION, null),
                data ->
                        (identifier, claimedLand) -> new DDFindBlockMechanic(identifier, claimedLand, data.get("self_action"), data.get("self_condition"), data.get("neighbour_action"), data.get("neighbour_condition")))
        );
